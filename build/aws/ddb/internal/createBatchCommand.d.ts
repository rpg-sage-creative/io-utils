...
export declare function createBatchCommand(type: "Delete" | "Get" | "Put", keys: RepoItem[], tableNameParser: TableNameParser): BatchGetItemCommand | BatchWriteItemCommand;
